...
| **LLM providers** | Anthropic, OpenAI, OpenRouter, Kimi, Gemini, Ollama, any OpenAI-compatible | OpenAI (primary), multi-profile failover |
...
- `OPENAI_API_KEY` + optional `OPENAI_BASE_URL` (OpenAI, OpenRouter, Kimi, Gemini, or another OpenAI-compatible provider)
...
| `OPENAI_API_KEY` | OpenAI-compatible API key (OpenAI, OpenRouter, Kimi, Gemini, etc.) |
| `OPENAI_BASE_URL` | Custom endpoint (OpenRouter, Kimi, Gemini, Ollama, etc.) |
